...
async function checkAdminBadge(){
  try {
    ...
    // is admin-only.
    if (admin || employee) {
      loadScriptsSequentially(['table-service-patch.js?v=20260939-history-loyalty-details', 'staff-order-patch.js', 'birthday-report-patch.js?v=20260944-advance-wishes-card']);
    }
    if (admin) {
